<div align="center">
  ...
  # إدارة حلقات تحفيظ القران  - الواجهة الأمامية (Web Client) 💻
...
## 🌟 نظرة عامة
يمثل `quran-halaqat-management-web` تطبيق الواجهة الأمامية (Client-Side) لمنظومة الفجر البرمجية. يوفر التطبيق لوحات تحكم مخصصة ومبنية على الأدوار والصلاحيات (Role-Based) لكل من: المشرفين العامين (Super Admins)، مدراء المساجد، المعلمين، أولياء الأمور، والطلاب.

تم تطوير المنصة باستخدام تقنية **Next.js (App Router)**، وهي تعتمد بشكل مكثف على **مكونات خادم ريأكت (React Server Components - RSC)** لضمان الأداء المثالي، وتحسين الأرشفة في محركات البحث (SEO)، وتقليل حجم حزم الجافا سكريبت المحملة لدى العميل.
